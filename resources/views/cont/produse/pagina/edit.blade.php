...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-header">Editeaza Pagina Produs</div>
                        <div class="card-body">
                            @if (session('status'))
                                ...
                                <div class="row">
                                    <div class="col-lg-6 pt-0">
                                        ...
                                        <div class="form-group col-lg-12 px-3">
                                            ...
                                            <input id="nume" type="text" class="form-control{{ $errors->has('nume') ? ' is-invalid' : '' }}" name="nume" value="{{ $data->nume }}" required>
                                        ...
                                        <div class="form-group col-lg-12 px-3">
                                            ...
                                            <textarea id="descriere" type="text" class="form-control{{ $errors->has('descriere') ? ' is-invalid' : '' }}" name="descriere" required>{{ $data->descriere }}</textarea>
                                        ...
                                        <div class="form-group col-lg-12 mb-0 px-3">
